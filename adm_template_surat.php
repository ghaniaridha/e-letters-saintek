...
if (isset($_POST['tambah'])) {
    ...
    echo "<script>alert('Template surat berhasil ditambahkan'); window.location='adm_template_surat.php';</script>";
}
...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('Template surat berhasil diperbarui'); window.location='adm_template_surat.php';</script>";
}
...
if (isset($_GET['hapus'])) {
    ...
    echo "<script>alert('Template surat berhasil dihapus'); window.location='adm_template_surat.php';</script>";
}
    ...
    <div class="admin-wrapper">
        ...
        <main class="main-content">
            <div class="page-title">
                ...
                <p>Templat yang ditambahkan admin otomatis muncul di halaman daftar templat mahasiswa.</p>
            </div>
            ...
            <div class="table-card">
                <form method="POST" enctype="multipart/form-data" style="display:flex; gap:10px; margin-bottom:20px; flex-wrap:wrap;">
                    ...
                    <?php if ($dataEdit) { ?>
                        ...
                        <a href="adm_template_surat.php" class="btn btn-delete">
                            Batal
                        </a>
                    <?php } else { ?>
                        ...
                        <?php if ($query && mysqli_num_rows($query) > 0) { ?>
                            ...
                            while ($row = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="adm_template_surat.php?edit=<?= $row['id_jenis']; ?>" class="btn btn-edit">
                                            Edit
                                        </a>

                                        <a href="adm_template_surat.php?hapus=<?= $row['id_jenis']; ?>"
