...
<body>
    ...
    <section id="daftar-surat" class="daftar-surat">
        ...
        <div class="layanan-container">
            <a class="layanan-card" href="form_pra_riset.php">
                <div class="layanan-content">
                    <h3>Permohonan<br>Pra Riset</h3>
                </div>
            </a>

            <a class="layanan-card" href="form_riset.php">
                <div class="layanan-content">
                    <h3>Permohonan<br>Riset</h3>
                </div>
            </a>

            <a class="layanan-card" href="form_cuti.php">
                <div class="layanan-content">
                    <h3>Permohonan<br>Cuti</h3>
                </div>
            </a>

            <a class="layanan-card" href="form_ket_aktif_kuliah_kembali.php">
                <div class="layanan-content">
