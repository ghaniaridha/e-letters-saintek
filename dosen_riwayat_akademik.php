...
<body class="dosen-page">
    ...
    <section id="daftar-surat" class="daftar-surat">
        <div class="riwayat-permohonan-header">
            ...
            <p>Daftar surat permohonan akademik mahasiswa yang sudah Anda verifikasi.</p>
        </div>

        <div class="table-wrapper" id="template-surat">
            <div class="search-container">
                <i class="fa-solid fa-magnifying-glass search-icon"></i>
                <input type="text" id="searchSurat" class="search-input" placeholder="Cari riwayat akademik...">
            </div>
                    ...
                    ?>
                        ...
                        <tr>
                            <td colspan="8" class="empty-table-cell">
                                ...
                                <p>Belum ada riwayat verifikasi akademik.</p>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
